...
xcopy /E /Y .\source\packages\chatroom_proxy .\source\target\wx\bucky\packages\
xcopy /E /Y .\source\packages\chatuser_proxy .\source\target\wx\bucky\packages\
xcopy /E /Y .\source\packages\history_proxy .\source\target\wx\bucky\packages\
